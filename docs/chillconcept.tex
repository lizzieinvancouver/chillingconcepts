...
\author{Lizzie, Justin Ngo, Fredi, Jonathan Auerbach (hopefully)} % Add Victor?
\date{\today}
\maketitle
\tableofcontents
...
\section{Current outline} % Early November 2024 in Gobabeb
...
\clearpage
\section{Old outline} % Lizzie in Nov 2024; I think this outline is from December 2022, but not sure and not online to check repo
