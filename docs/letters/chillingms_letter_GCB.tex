...
Please consider our paper, entitled `The problem and promise of modeling plant budburst under warmer winters' as a perspective for  \emph{Global Change Biology}. 

\emph{What scientific question is addressed in this manuscript?} % 48
...
\emph{What is/are the key finding(s) that answer this question?} % 50

We highlight fundamental problems with chilling that impact all models of plant leafout today. These include the reality that chilling is an unobserved process, which may lead to current highly uncertain and variable forecasts. We suggest a path towards more mechanistic models that build on and help design experimental results. 
...
\emph{Describe how your paper fits within the scope of GCB.} % 45
...
We bring a cross-disciplinary and solutions-focused perspective on chilling, a concept critical to predicting and mitigating impacts of climate change. We bridge across ecological forecasting, molecular biology, forest tree and crop modelers to highlight the problems that may limit the potential for rapid progress. 

\emph{What biological AND global change aspects does it address?} % 

An improved understanding of chilling is integral to managing agricultural and forest systems with continued climate change, with implications for ... XX and also important to fundamental biology. 
...
Zhao, Y., Antoniou-Kourounioti, R.L., Calder, G., Dean, C. \& Howard, M. (2020) Temperature- dependent growth contributes to long-term cold sensing. Nature 583, 825–829.
